package fr.hyperion.defmarket.controller.pro.store.mapper;
...
@Mapper(uses = {DocumentMapper.class, AddressMapper.class, GeolocationMapper.class, PhoneMapper.class, SocialMediaMapper.class, TemporaryClosureMapper.class})
public interface StoreMapper {
    ...
    List<StoreCompanyResponse> toResponseStore(List<Store> allCompanyStores);
