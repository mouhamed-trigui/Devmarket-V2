    ...
    const calcValues = () => {
        if (dataOffre?.value && dataOffre?.value !== '') {
            if (dataOffre.offerType === 'PERCENTAGE' && dataOffre?.value) {
                ...
                if (
                    Math.floor(Number(dataOffre.value)) > 0 &&
                    Math.floor(Number(dataOffre.value)) <= 4
                ) {
                    setValues(undefined);
    ...
    useEffect(() => {
        if (dataOffre?.offerType === 'PERCENTAGE') {
            if (
                ...
                Math.floor(Number(dataOffre?.minOfferValue)) > 0 &&
            ...
            if (
                dataOffre?.minOfferValue &&
                Number(dataOffre?.minOfferValue) > 0 &&
        ...
        <View>
            ...
            <VStack marginBottom={3} marginTop={5}>
                <FormControlTextarea
                    ...
                    helperText={null}
                    onChange={(value: any) =>
                        setdataOffre((old) => ({ ...old, description: value }))
                    }
                />
                <DatePickerModal
                    required
            ...
            <VStack marginBottom={10} marginTop={10}>
                <FilePicker
                    value={
                        dataOffre?.attachedFile
                            ? typeof dataOffre?.attachedFile === 'string'
                                ? dataOffre.attachedFile.split('/').pop()
                ...
                >
                    <View marginTop={6}>
                        <HStack space={2} marginX={25}>
                            <Image
                                accessibilityLabel="image-edit-offer"
                                source={image}
                                style={{
                                    width: 45,
                                    height: 50,
