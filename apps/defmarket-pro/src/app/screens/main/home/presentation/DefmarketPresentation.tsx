    ...
    const [features, setFeatures] = React.useState<IFeatureDescriptionProps[]>([
        {
            ...
            icon: Platform.OS === 'web' ? businessPNG : businessSVG,
            description:
        ...
        },
        {
            ...
            icon: Platform.OS === 'web' ? entreprisePNG : entrepriseSVG,
        ...
        {
            title: 'Mes Boutiques',
            icon: Platform.OS === 'web' ? boutiquePNG : boutiqueSVG,
        ...
        {
            title: 'Mes Offres',
            icon: Platform.OS === 'web' ? offerPNG : offerSVG,
        ...
        },
        {
            ...
            icon: Platform.OS === 'web' ? CreateOfferPNG : CreateOfferSVG,
            description:
