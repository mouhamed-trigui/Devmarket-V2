        ...
        >
            <VStack marginTop={5} marginBottom={10} marginX={6} space={2}>
                ...
                <VStack space={6} marginTop={5}>
                    ...
                    <HStack width="80%" space={4}>
                        <SvgXml xml={dates} style={{ width: 33, height: 33 }} />
                        <Text
                            color={system[50]}
                            fontFamily="body"
                            fontSize="dm-p"
            ...
            <VStack marginTop={5} marginBottom={10} marginX={6} space={5}>
                ...
                <HStack width="80%" space={4}>
                    <SvgXml xml={beneficiaireC} style={{ marginTop: 3 }} />
                    <Text
                        color={system[50]}
                        fontFamily="body"
                        fontSize="dm-p"
                ...
                <HStack width="80%" space={4}>
                    <SvgXml xml={beneficiaireB} style={{ marginTop: 3 }} />
                    <Text
                        color={system[50]}
                        fontFamily="body"
                        fontSize="dm-p"
                ...
                <HStack width="80%" space={4}>
                    <SvgXml xml={beneficiaireA} style={{ marginTop: 3 }} />
                    <Text
                        color={system[50]}
                        fontFamily="body"
                        fontSize="dm-p"
