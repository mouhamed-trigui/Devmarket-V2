...
const StructureEdit = (props: ICompanyEdit) => {
    ...
    const description =
        'Contacte un administrateur via le chat de ton application afin de modifier les données de ton entreprise.';
    ...
    return (
        <SafeArea>
            ...
            <YesNoDialog
                ...
                body="Es-tu sûr de vouloir supprimer cette entreprise et toutes ses boutiques ? Les données supprimées ne peuvent pas être récupérées."
            />
