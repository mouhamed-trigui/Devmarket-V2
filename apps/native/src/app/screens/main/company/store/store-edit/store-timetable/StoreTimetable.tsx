...
const StoreTimetable = () => {
    ...
    const handleVerifTimesDay = () => {
        const hasBadWorkingTime = timetables.some((day) => {
            if (day.active) {
                if (
                    !day?.workingTime ||
                    day?.workingTime?.length === 0 ||
                    day?.workingTime.find((wt) => !wt.start || !wt.end)
                ) {
                    return true;
                }
            }
        ...
        if (hasBadWorkingTime || timetables.every((day) => !day.active)) {
            Alert.alert(
                'Informations',
                "Le remplissage des horaires n'est pas encore terminé ou aucun jour n'était séléctionné, veuilles le terminer en sélectionnant au moins un jour et présiser les horaires d'ouverture et de fermeture.",
                [
                    {
                        text: 'OK',
                    },
        ...
        <DatePickerModal
            ...
            inputStyle={{
                ...
                container: {
                    width: 55,
                    backgroundColor: 'transparent',
                    borderColor: props.value ? 'white' : '#e5e5e5',
                    borderWidth: 1,
                    borderRadius: 5,
                    paddingVertical: 10,
                },
    ...
    const Content = () => (
        ...
        >
                    ...
                    <VStack space={2} key={day.day}>
                        ...
                        >
                            ...
                            <HStack space={5} alignItems="center">
                                ...
                                <TouchableOpacity
                                    onPress={() => handleRemoveTimetable(i, 0)}
                                >
                                    <Image
                                        source={closeBtnPng}
            ...
            <VStack space={5} marginTop={5}>
                ...
                <Button
                    label="Mettre à jour"
                    onPress={handleVerifTimesDay}
                    isDisabled={
                        !['', null, undefined].includes(
                            temporaryClosure.closureType
                        ) &&
                        ['', null, undefined].includes(temporaryClosure.reason)
                    }
                />
            </VStack>
        </Box>
