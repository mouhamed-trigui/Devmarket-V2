...
const OffreDetails = () => {
    ...
    const downloadFileOffer = async (fileId: number, filename: string) => {
        ...
        const url = getFileURL(fileId, true);
            ...
            <Center>
                {selectedOffer?.attachedFile && (
                    <TouchableOpacity
                        onPress={() =>
                            downloadFileOffer(
                                selectedOffer?.attachedFile?.id,
                                selectedOffer?.attachedFile?.name
                            )
                        }
                        style={{
                            position: 'relative',
                ...
                {selectedOffer?.photo && (
                    <Image
                        source={{ uri: getFileURL(selectedOffer?.photo?.id) }}
                        style={{
                            marginTop: 5,
                            borderRadius: 5,
                            height: 130,
