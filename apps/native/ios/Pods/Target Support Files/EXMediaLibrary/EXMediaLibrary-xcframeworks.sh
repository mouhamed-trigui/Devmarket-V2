...
install_xcframework "${PODS_ROOT}/../../node_modules/expo-media-library/ios/EXMediaLibrary.xcframework" "EXMediaLibrary" "framework" "ios-arm64_x86_64-simulator" "ios-arm64"
