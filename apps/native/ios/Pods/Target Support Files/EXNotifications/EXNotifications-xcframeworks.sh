...
install_xcframework "${PODS_ROOT}/../../node_modules/expo-notifications/ios/EXNotifications.xcframework" "EXNotifications" "framework" "ios-arm64_x86_64-simulator" "ios-arm64"
